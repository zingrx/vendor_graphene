...
custom_local_manifest = ".repo/local_manifests/graphene_manifest.xml"
custom_default_revision = "13"
custom_dependencies = "graphene.dependencies"
org_manifest = "graphene-devices"  # leave empty if org is provided in manifest
org_display = "Graphene-Devices"  # needed for displaying
